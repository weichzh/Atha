        ...
        "/atha-reader.mjs" => (
            Cow::Owned(
                [
                    ...
                    include_bytes!("../../../web/style-module-package.mjs").as_slice(),
                    include_bytes!("../../../web/preferences.mjs").as_slice(),
                    ...
                    include_bytes!("../../../web/content-actions.mjs").as_slice(),
                    include_bytes!("../../../web/structured-actions.mjs").as_slice(),
                    include_bytes!("../../../web/reader-state.mjs").as_slice(),
                    include_bytes!("../../../web/bookmarks.mjs").as_slice(),
                    include_bytes!("../../../web/search.mjs").as_slice(),
                    include_bytes!("../../../web/annotation-store.mjs").as_slice(),
                    include_bytes!("../../../web/annotations.mjs").as_slice(),

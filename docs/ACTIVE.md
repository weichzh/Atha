...
- `change`：离线词典垂直切片 → `docs/changes/offline-dictionary-vertical-slice.md`
- `now`：实现 MDict 与经典 Kindle 离线词典的导入、精确查词、安全文本释义、Linux GUI 与 PCT-AL10 性能验收。
- `next`：在真机研究证据上改造首行缩进、字号 / DPI 滑块、左右滑动 / 纵向滚动两种阅读方式，以及 Readest 风格设置菜单、动画与选区查词交互。

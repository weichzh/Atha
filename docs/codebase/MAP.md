...
- 完整消息后端 interface 集成测试 16/16 通过，覆盖迁移、事务、富文本 allowlist 与纯文本投影、修订冲突、关系、FTS、快照资源、旧标注迁移、自包含导出及同一 Edition 重开恢复；Markdown 双向转换测试、Svelte check、production build 与 Tauri command seam 测试通过；

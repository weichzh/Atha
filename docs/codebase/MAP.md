...
| `reader/app/src/components/LibraryView.svelte`、`reader/app/src/library.ts` | 系统选择器 / 桌面拖放共用导入结果、网格 / 列表书架、冷启动一次性打开，以及独立应用主题、全书阅读默认恢复、词典和本地资料设置投影 | Linux GUI 已验证 |
